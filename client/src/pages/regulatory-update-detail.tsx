...
3. Regulatorische Analyse für Risikobewertung konsultieren
        ...
        <TabsContent value="ai-analysis">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Strukturelle Compliance-Risiko- und Wirkungsbewertung (ohne KI-Inhalte)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-purple-50 p-6 rounded-lg">
                <h4 className="font-semibold text-purple-900 mb-4 flex items-center gap-2">
                  ...
                  Regulatorische Risiko- und Wirkungsanalyse
                </h4>
...
**Wirkungsindikatoren (heuristisch):**
...
• **Regulatorische Analyse:** Abgeschlossen
