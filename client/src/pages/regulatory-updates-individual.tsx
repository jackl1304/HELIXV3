...
import { ContentTimestampBadge } from '@/components/content-timestamp-badge';
...
export default function RegulatoryUpdatesPage() {
  ...
  const filteredUpdates = useMemo(() => {
    ...
    return updates
      .filter((update: RegulatoryUpdate) => {
      ...
      .sort((a, b) => {
        // Sortierung: Neueste zuerst (published_at oder created_at)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 text-purple-700 rounded-md text-xs font-medium">
