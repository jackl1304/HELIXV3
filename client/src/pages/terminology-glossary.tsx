      ...
      <div className="flex flex-col space-y-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-2">
            Umfassende Begriffsdokumentation mit Quellen, automatisierten Analysen und praktischen Anwendungen
          </p>
        </div>
              ...
              <AccordionContent className="px-6 pb-6">
                <Tabs defaultValue="definition" className="space-y-4">
                  <TabsList className="grid w-full grid-cols-4">
                    ...
                    <TabsTrigger value="analysis">Regulatorische Analyse</TabsTrigger>
