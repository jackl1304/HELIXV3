...
import { BookOpen, Search, Download, ExternalLink, Clock, FileText, Brain, Globe, Calendar, Eye, Bookmark, Star, Filter } from "@/components/icons";
          ...
          <TabsContent value="analysis-ai" className="mt-6">
            <Card className="border-0 shadow-lg border-l-4 border-l-orange-500">
              <CardHeader className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/10 dark:to-red-900/10 border-b">
                ...
                <CardDescription className="text-gray-600 dark:text-gray-400">
                  Fortschrittliche automatisierte Analyse zur Bewertung und Kategorisierung von Wissensartikeln
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="text-center py-12 text-gray-500">
