...
import { Building2, Users, FileText, TrendingUp, Clock, Shield, Star, Zap, Crown, Lock } from "@/components/icons";
                      ...
                      <div key={update.id || index} className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <h4 className="font-semibold text-blue-900 break-words">{update.title}</h4>
                            <p className="text-sm text-gray-600 mt-1">{update.summary || update.description}</p>
                            <div className="flex flex-wrap items-center gap-2 mt-2">
                              <Badge variant="outline" className="text-xs">
                                {update.type || 'regulatory'}
                              </Badge>
                              {update.agency && (
                                <Badge variant="secondary" className="text-xs bg-white/60 border-blue-300 text-blue-700">
                                  {update.agency}
                                </Badge>
                              )}
                              {update.region && (
                                <Badge variant="secondary" className="text-xs bg-white/60 border-purple-300 text-purple-700">
                                  {update.region}
                                </Badge>
                              )}
                            </div>
