...
import { Loader2, Search, Brain, TrendingUp, FileText, ExternalLink, Zap, AlertTriangle } from "@/components/icons";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Regulatory Intelligence Search</h2>
          <p className="text-gray-600">Intelligente Suche in regulatorischen Dokumenten und Updates</p>
        </div>
      </div>
                ...
                <div className="space-y-4">
                  <Alert className="bg-green-50 border-green-200">
                    ...
                    <AlertDescription className="text-green-900">
                      Analyse abgeschlossen für: "{searchMutation.variables}"
                    </AlertDescription>
                  </Alert>
