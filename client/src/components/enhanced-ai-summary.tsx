...
import { Brain, TrendingUp, AlertTriangle, CheckCircle, Shield, Target, Scale, Zap } from "@/components/icons";
...
export function EnhancedAISummary({
  ...
  // Automatische rechtliche Wirkungsanalyse basierend auf echten Inhalten
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-gray-50 p-3 rounded-lg border-l-4 border-blue-500">
          <p className="text-xs text-gray-600">
            <strong>Wirkungsanalyse basiert auf:</strong> Vollständiger Urteilstext, Gerichtsbeschluss,
