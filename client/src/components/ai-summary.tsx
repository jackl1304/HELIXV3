...
import { Brain, Loader2, ChevronDown, ChevronUp, Lightbulb, AlertTriangle, CheckCircle } from "@/components/icons";
...
// Mock rechtliche Kurzbewertung für bessere Performance (echte API später)
