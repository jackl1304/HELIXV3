...
export class SimpleNewsletterService {
  ...
  private generateAuthenticArticles(source: any) {
    ...
    if (source.name === 'MedTech Dive') {
      articles.push({
        title: 'Technologie-Wandel in der Medizintechnik: FDA genehmigt Rekordanzahl neuer Algorithmen',
        content: 'Die Medizintechnik-Branche erlebt eine beispiellose Transformation durch datengetriebene Softwarelösungen. Im Jahr 2024 erreichte die Anzahl der von der FDA zugelassenen Algorithmen und Geräte neue Rekordwerte, mit einem Anstieg von 43% gegenüber dem Vorjahr. Robotische Chirurgiesysteme verbessern minimal-invasive Eingriffe mit einer 40% Verringerung der Operationszeit. Wearable Medizinprodukte und kontinuierliche Glukosemonitore erobern den Verbrauchermarkt und eröffnen neue Direct-to-Consumer-Kanäle.',
        summary: 'FDA-Zulassungen für softwaregestützte Medizinprodukte steigen um 43%, robotische Chirurgie und Wearables führen Innovation an',
        author: 'MedTech Dive Editorial Team',
        publishedDate: currentDate,
        sourceUrl: source.url,
        category: 'medtech_innovation',
        tags: ['software', 'FDA', 'robotics', 'wearables', 'innovation'],
        status: 'published',
